...
public class ShowMetricsPatternCompleter implements Completer {
    ...
    public int complete(Session session, CommandLine commandLine, List<String> candidates) {
        ...
        final ShowMetricsCommand.SearchType type = getType(session, commandLine);
        switch (type) {
        case service:
    ...
    private ShowMetricsCommand.SearchType getType(Session session, CommandLine commandLine) {
        if (session == null) {
            return null;
        }
